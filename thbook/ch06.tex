...
* |svg2th2-command <OS command>|

  System command to convert an SVG file to a Therion 2D file. The command
  must take one argument, the name of the SVG file to convert, and write the
  result to the standard output. Allows to use |*.svg| files instead
  of |*.th2| files with the |input| command.
